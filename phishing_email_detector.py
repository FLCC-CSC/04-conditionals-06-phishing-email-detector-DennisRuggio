...
# NAME: Dennis Ruggio
# DATE: 10/2/25
# BRIEF DESCRIPTION: phishing_email_detector.py project  
...
I liked using 'in' because it definitely felt natural. It sounds more like the way humans speak. 
For example saying something like "Hey if there's a check in the mail put it on the counter, otherwise toss the mail in the recycling" which is basically the equivalent of what we worked on here.
The fun part was the trial and error part of seeing if you could seperate different key words using 'in' and 'or' and seeing that you could.
